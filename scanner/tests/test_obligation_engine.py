...
class TestAllObligationFiles:
    def test_all_10_obligation_files_load(self):
    ...
    def test_total_94_obligations(self):
        """Total across all files should be 94 (82 original + 12 from cross-verification fixes:
        Art09+1, Art10+1, Art11+4, Art13+1, Art14+1, Art15+1, Art50+3)."""
        obligations_dir = os.path.join(os.path.dirname(__file__), "..", "obligations")
        total = 0
