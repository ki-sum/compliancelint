...
- After all 10 articles, call cl_export_report to generate a compliance report
```
...
```
▶ Art. 5 — Prohibited Practices (1/10)
...
▶ Art. 6 — Risk Classification (2/10)
